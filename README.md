...
3. Select which image fields should have the Grok Imagine interface enabled.
4. Choose your preferred default model and resolution.

## How to Use

1. Open a page for editing that contains an enabled image field.
2. Locate the **Grok Imagine** bar below the image field.
3. Enter a prompt, select your desired aspect ratio and quantity.
4. Click **Generate**.
